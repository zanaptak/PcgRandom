...
#define XX_SRANDOM_SEEDCONSTS       18446744073709551615ULL, 18446744073709551615ULL
#define XX_SRANDOM(...)             \
            pcg_setseq_64_srandom_r(&rng, __VA_ARGS__)
#define XX_RANDOM()                 \
            pcg_setseq_64_rxs_m_xs_64_random_r(&rng)
#define XX_BOUNDEDRAND(bound)       \
            pcg_setseq_64_rxs_m_xs_64_boundedrand_r(&rng, bound)
