...
#define XX_SRANDOM_SEEDCONSTS       6825295307272534016ULL
#define XX_SRANDOM(...)             \
            pcg_mcg_64_srandom_r(&rng, __VA_ARGS__)
#define XX_RANDOM()                 \
            pcg_mcg_64_xsl_rr_32_random_r(&rng)
#define XX_BOUNDEDRAND(bound)       \
            pcg_mcg_64_xsl_rr_32_boundedrand_r(&rng, bound)
